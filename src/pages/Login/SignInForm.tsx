...
const SignInForm = () => {
  ...
  const handleSubmit = (e: SyntheticEvent) => {
    ...
    else enqueueSnackbar("Wrong Captcha", AlertErrorProp as any);
  };
  ...
  const login = () => {
    userLogin({
      ...
      .then(() => {
        ...
        enqueueSnackbar("Login successfully", AlertSuccessProp as any);
      })
      .catch((error) => {
        enqueueSnackbar("Error", AlertErrorProp as any);
      });
  };

  const loginGoogleOauth = (oauthJwt: string) => {
    loginGoogle({
      variables: {
        token: oauthJwt,
      },
      ...
      .then(() => {
        ...
        enqueueSnackbar(
          ...
          AlertSuccessProp as any
        );
      })
      .catch((error) => {
        enqueueSnackbar("Google login error", AlertErrorProp as any);
      });
  };
  ...
  const onFailGoogleLogin = (res: any) => {
