...
const SignUpForm = () => {
  ...
  const handleVisibility = (e: SyntheticEvent) => {
  ...
  const register = () => {
    registerUser({
      ...
      .then(() => {
        history.push("/login");
        enqueueSnackbar("Please check your email", AlertSuccessProp as any);
      })
      .catch((e) => {
  ...
  const handleSubmit = (e: SyntheticEvent) => {
    e.preventDefault();
    if (!validate()) {
      enqueueSnackbar("Invalid input", AlertErrorProp as any);
      return;
    }
    register();
  };
